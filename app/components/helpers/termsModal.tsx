...
const TermsModal = () => {
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-[10]">
        <div className="bg-white/80 backdrop-blur-lg rounded-lg shadow-lg w-full max-w-lg relative">
          {/* Header */}
          <div className="flex justify-between items-center p-4">
            <h2 className="text-xl font-semibold text-gray-800 transition-opacity duration-300">
              {showTerms ? 'Terms and Conditions' : 'Privacy Policy'}
            </h2>
            <div
              onClick={handleClose}
          ...
          <div className="p-4 space-y-4 max-h-96 overflow-y-auto relative">
            <div 
              className={`space-y-4 text-gray-600 transition-opacity duration-300 ${
                isAnimating ? 'opacity-0' : 'opacity-100'
              }`}
            >
              {(showTerms ? termsText : policyText).split('\n').map((paragraph, index) => (
                paragraph.trim() && (
          ...
          <div className="p-4 flex justify-between items-center">
            <div
              ...
              className="text-gray-600 font-medium cursor-pointer hover:text-gray-800"
            >
              View {showTerms ? 'Privacy Policy' : 'Terms & Conditions'}
            </div>
            <div
